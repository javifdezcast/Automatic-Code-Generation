...
namespace UPM_IPS.IGGORCJCFProyectoIPS
{
	...
	/// </summary>
	internal partial class IGGORCJCFProyectoIPSDocView : IGGORCJCFProyectoIPSDocViewBase
	{
		/// <summary>
		/// Constructs a new IGGORCJCFProyectoIPSDocView.
		/// </summary>
		public IGGORCJCFProyectoIPSDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class IGGORCJCFProyectoIPSDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new IGGORCJCFProyectoIPSDocView.
		/// </summary>
		protected IGGORCJCFProyectoIPSDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			IGGORCJCFProyectoIPSDocDataBase docData = this.DocData as IGGORCJCFProyectoIPSDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for IGGORCJCFProyectoIPSDocViewBase should be an IGGORCJCFProyectoIPSDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::UPM_IPS.IGGORCJCFProyectoIPS.IGGORCJCFProyectoIPSDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::UPM_IPS.IGGORCJCFProyectoIPS.IGGORCJCFProyectoIPSDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.IGGORCJCFProyectoIPS.IGGORCJCFProyectoIPSToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::UPM_IPS.IGGORCJCFProyectoIPS.IGGORCJCFProyectoIPSToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.IGGORCJCFProyectoIPSDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::UPM_IPS.IGGORCJCFProyectoIPS.IGGORCJCFProyectoIPSHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::UPM_IPS.IGGORCJCFProyectoIPS.IGGORCJCFProyectoIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::UPM_IPS.IGGORCJCFProyectoIPS.IGGORCJCFProyectoIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
