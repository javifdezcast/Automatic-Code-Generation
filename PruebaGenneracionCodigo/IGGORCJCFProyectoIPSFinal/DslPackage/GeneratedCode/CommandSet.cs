...
namespace UPM_IPS.IGGORCJCFProyectoIPS
{
	...
	/// </summary>
	internal partial class IGGORCJCFProyectoIPSCommandSet : IGGORCJCFProyectoIPSCommandSetBase
	{
		/// <summary>
		/// Constructs a new IGGORCJCFProyectoIPSCommandSet.
		/// </summary>
		public IGGORCJCFProyectoIPSCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class IGGORCJCFProyectoIPSCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new IGGORCJCFProyectoIPSCommandSetBase.
		/// </summary>
		protected IGGORCJCFProyectoIPSCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewIGGORCJCFProyectoIPSExplorerCommand,
				typeof(IGGORCJCFProyectoIPSEditorFactory).GUID);
		...
		{
			IGGORCJCFProyectoIPSExplorerToolWindow explorer = this.IGGORCJCFProyectoIPSExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected IGGORCJCFProyectoIPSDocData CurrentIGGORCJCFProyectoIPSDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as IGGORCJCFProyectoIPSDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected IGGORCJCFProyectoIPSDocView CurrentIGGORCJCFProyectoIPSDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as IGGORCJCFProyectoIPSDocView;
			}
		}
		...
		/// </summary>
		protected IGGORCJCFProyectoIPSExplorerToolWindow IGGORCJCFProyectoIPSExplorerToolWindow
		{
			get
			{
				IGGORCJCFProyectoIPSExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(IGGORCJCFProyectoIPSExplorerToolWindow), true) as IGGORCJCFProyectoIPSExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				IGGORCJCFProyectoIPSExplorerToolWindow explorerWindow = this.IGGORCJCFProyectoIPSExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class IGGORCJCFProyectoIPSClipboardCommandSet : IGGORCJCFProyectoIPSClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new IGGORCJCFProyectoIPSClipboardCommandSet.
		/// </summary>
		public IGGORCJCFProyectoIPSClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class IGGORCJCFProyectoIPSClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new IGGORCJCFProyectoIPSClipboardCommandSetBase.
		/// </summary>
		protected IGGORCJCFProyectoIPSClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
