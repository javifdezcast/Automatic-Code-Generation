...
namespace UPM_IPS.IGGORCJCFProyectoIPS
{
	...
	/// </remarks>
	public partial class IGGORCJCFProyectoIPSHelpKeywordHelper : IGGORCJCFProyectoIPSHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new IGGORCJCFProyectoIPSHelpKeywordHelper.
		/// </summary>
		protected IGGORCJCFProyectoIPSHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the IGGORCJCFProyectoIPSHelpKeywordHelper.
		/// </summary>
		public static IGGORCJCFProyectoIPSHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class IGGORCJCFProyectoIPSHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new IGGORCJCFProyectoIPSHelpKeywordHelperBase.
		/// </summary>
		protected IGGORCJCFProyectoIPSHelpKeywordHelperBase()
			: base() { }
